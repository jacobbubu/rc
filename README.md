...
You can also specify the corresponding rc file name when updating, which will affect the result of the merge because of the priority the of the rc file.
